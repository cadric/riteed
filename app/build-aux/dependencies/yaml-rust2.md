...
- Cargo source review: `cargo tree -e normal -p yaml-rust2 --target all` shows active normal dependencies `arraydeque`, `hashlink`, `hashbrown 0.16.1`, and `foldhash`, all locked through `app/build-aux/cargo/cargo-sources.json`.
