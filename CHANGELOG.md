...
- Added sub-flow markers for the V8 GTK polish smoke and kept its presentation
  preference check on a presented window without exercising the real fullscreen
  transition in headless CI.
